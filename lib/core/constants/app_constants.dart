class AppConstants {
  ...
  // HTTPS Deep Link (for better clickability in messaging apps)
  static const String httpsDeepLinkDomain = 'watcho.app';
  static const String httpsDeepLinkPath = '/movie';
